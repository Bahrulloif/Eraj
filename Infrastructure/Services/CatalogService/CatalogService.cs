...
public class CatalogService : ICatalogService
{
    ...
    public async Task<Response<string>> AddCatalog(AddCatalogDTO catalog)
    {
        ...
        return new Response<string>("Catalog added successfully");
    }

    public async Task<Response<string>> UpdateCatalog(AddCatalogDTO catalog)
    {
        if (catalog == null)
        {
        ...
        if (find != null)
        {
            ...
            await _context.SaveChangesAsync();
            return new Response<string>("Update is success");
        }
        return new Response<string>(HttpStatusCode.NotFound, "Catalog not found");
    }
