...
public class RecommendationService : IRecommendationService
{
    ...
    public async Task<Response<List<RecommendationDto>>> GetRecommendation(string model)
    {
        ...
        .Select(x => new RecommendationDto()
        {
            ...
            Where(z => z.ProductType == ProductType.NoteBook && z.ProductId == x.Id && z.SubCategoryId == x.SubCategoryId).
        ...
        .Select(y => new RecommendationDto()
        {
            ...
            Image = _context.Pictures.
            Where(z => z.ProductType == ProductType.SmartPhone && z.ProductId == y.Id && z.SubCategoryId == y.SubCategoryId).
        ...
        .Select(z => new RecommendationDto()
        {
            ...
            Image = _context.Pictures.
            Where(a => a.ProductType == ProductType.Tablet && a.ProductId == z.Id && a.SubCategoryId == z.SubCategoryId).
            Select(y => new PictureDto{Id = y.Id, ImageName = y.ImageName}).
            ToList()
        }).AsNoTracking().ToListAsync();
