...
public interface ICommercialRealEstateService
{
    ...
    public Task<Response<string>> AddCommercialRealEstate(AddCommercialRealEstateDTO commercialRealEstate, string currentUserId);
    public Task<Response<string>> UpdateCommercialRealEstate(AddCommercialRealEstateDTO commercialRealEstate, string currentUserId, bool isPrivileged);
    public Task<Response<string>> DeleteCommercialRealEstate(int commercialRealEstateId, string currentUserId, bool isPrivileged);
}
